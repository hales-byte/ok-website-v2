...
**Sırada:** ✅ Yayınlandı — onayla v3'e alındı (commit d938565) ve canlıda teyit edildi: ana sayfa 36.141, Balıkesir sayfası 2.721 + 38 LED + yeni ilçe kapsaması. (Yerel derleme bu bilgisayarda yine takıldığı için doğrulama geçici bir önizleme dalının Vercel derlemesiyle yapıldı; canlıya yansıması için ek bir tetikleyici gönderim gerekti.)
...
**Sırada:** ✅ Yayına alındı — güvenlik yaması ile birlikte geçici bir önizleme dalında test edildi, Vercel derlemesi temiz geçti, sonra v3'e alındı ve önizleme dalı silindi. Cevap bekleyen bir veri sorusu duruyor: İzmir, Kocaeli, Sivas, Amasya ve Tokat'ta envanterde sadece 1-3 ünite görünüyor (gerçek veri bekleniyor).
